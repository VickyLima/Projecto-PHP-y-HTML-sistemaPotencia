<?php
	...
	class PDF extends FPDF
	{
		function Header()
		{
			...
			$this->Ln(20);
            $this->Cell(50,120, utf8_decode('PRODUCTOS POR REGISTRO'),0,1,'C');
            $this->Ln(-50,50);

			$this->SetFillColor(0,0,0);
			$this->SetTextColor(0,0,0);
			$this->SetFont('Arial','B',12);
			$this->Cell(30,6,'NUMERO:',0,1,'L',0);
			$this->Cell(30,6,'CLAVE:',0,1,'L',0);
			$this->Cell(30,6,'MARCA:',0,1,'L',0);
			$this->Cell(30,6,'COLOR:',0,1,'L',0);
			$this->Cell(30,6,'MODELO:',0,1,'L',0);
			$this->Cell(30,6,'DESCRIPCION:',0,1,'L',0);
			$this->Cell(30,6,'CARROCERIA:',0,0,'L',0);
