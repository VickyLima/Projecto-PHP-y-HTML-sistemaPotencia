...
?>
        <div class="formulario">
           <form method="REQUEST" action="productosActualizarFuncion.php">
		   <br><div class="card">
 ...
 <h1 class="text-white text-center"> Buscar Producto </h1>
                ...
                <br><a href="productosActualizarFuncion.php?idProducto=<?php echo !isset($_GET['idProducto']); ?>" class="btn btn-info enlace">Buscar</a></br>
