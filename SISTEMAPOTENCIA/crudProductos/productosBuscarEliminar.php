...
?>
        <div class="formulario">
           <form method="GET" action="productosBorrarAccion.php">
		   <br><div class="card">
 ...
 <h1 class="text-white text-center"> Buscar Producto </h1>
                ...
                <input placeholder="Escribe el numero del producto" name="idProducto" class="cajaTexto" value=""><br>
				
                <button onclick="return Confirm()" class="btn btn-danger enlace">Eliminar</button>
<!--<th><a onclick="return Confirm()" href="marcaEliminarAccion.php?idMarca=<?php echo ['idProducto'] ?>" class="btn btn-danger">Eliminar</a></th>-->
