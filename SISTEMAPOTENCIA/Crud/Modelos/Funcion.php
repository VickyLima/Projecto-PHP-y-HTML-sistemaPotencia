    ...
    <a href="#">Catalogos</a>
      <div class="dropdown clearfix">
        ...
        <ul>
          ...
          <li><a href="../../Crud/Colores/coloresBuscarActualizar.php">Editar</a></li>
          <li><a href="../../Crud/Colores/coloresBuscarEliminar.php">Eliminar</a></li>
</ul>
            <ul>
          ...
          <li><a href="../../Crud/Modelos/modelosBuscarEliminar.php">Eliminar</a></li>
 </ul>
            <ul>
    ...
    <li>
      ...
      <div class="dropdown clearfix">
        ...
        <li><a href="#">Perfil</a></li>
          <li><a href="../../login2/index.php">Cerrar Sesión</a></li>
