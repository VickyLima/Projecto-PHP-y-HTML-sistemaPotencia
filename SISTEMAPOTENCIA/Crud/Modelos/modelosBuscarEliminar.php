...
?>
        <div class="formulario">
           <form method="GET" action="modelosEliminarAccion.php">
		   <br><div class="card">
 ...
 <h1 class="text-white text-center"> Buscar Modelo </h1>
                ...
                <input placeholder="Escribe el numero del modelo" name="claveModelos" class="cajaTexto" value=""><br>
				
                <button onclick="return Confirm()" class="btn btn-danger enlace">Eliminar Registro</button>
