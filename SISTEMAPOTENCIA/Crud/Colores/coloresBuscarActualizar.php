...
?>
        <div class="formulario">
           <form method="REQUEST" action="coloresActualizarFormulario.php">
		   <br><div class="card">
 ...
 <h1 class="text-white text-center"> Buscar marca </h1>
                ...
                <br><a href="coloresActualizaFormulario.php?claveColor=<?php echo !isset($_GET['claveColor']); ?>" class="btn btn-info enlace">Buscar</a></br>
